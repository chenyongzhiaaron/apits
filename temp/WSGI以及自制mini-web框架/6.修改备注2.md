...
![image-20190425083658339](assets/image-20190425083658339.png)

![image-20190425083723353](assets/image-20190425083723353.png)

![image-20190425083736824](assets/image-20190425083736824.png)

### 2.2 修改时有中文

![image-20190425083829624](assets/image-20190425083829624.png)

![image-20190425083842981](assets/image-20190425083842981.png)

发现问题：当修改时提交的数据如果有中文，那么此时就会出现看上去的乱码情况，其实这是因为如果中文在向服务器传递时，如果放到了URL中，那么就会自动进行修改编码，想要解决这个问题，就要看url编码知识