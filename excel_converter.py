...
if __name__ == '__main__':
    ...
    postman_out_file = os.path.join(BaseDates.base_path, 'data', 'test_cases', 'test_postman_cases.xlsx')  # 转化后的文件保存的位置
    openapi_to_json = r'.\data\temporary_file\openapi.json'  # postman导出的json文件
    openapi_out_file = os.path.join(BaseDates.base_path, 'data', 'test_cases', 'test_openapi_cases.xlsx')  # 转化后的文件保存的位置
